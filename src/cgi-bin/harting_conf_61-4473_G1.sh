...
echo "sets up RSTP path cost parameters
	for ports 1,2 400k
	for ports 3,4,5,6, 800k"
snmpset -v 1 -c private $ip 1.3.6.1.4.1.21108.116.2.2.1.11.1 i 400000 >> /tmp/conflog.txt
snmpset -v 1 -c private $ip 1.3.6.1.4.1.21108.116.2.2.1.11.2 i 400000 >> /tmp/conflog.txt
snmpset -v 1 -c private $ip 1.3.6.1.4.1.21108.116.2.2.1.11.3 i 800000 >> /tmp/conflog.txt
snmpset -v 1 -c private $ip 1.3.6.1.4.1.21108.116.2.2.1.11.4 i 800000 >> /tmp/conflog.txt
snmpset -v 1 -c private $ip 1.3.6.1.4.1.21108.116.2.2.1.11.5 i 800000 >> /tmp/conflog.txt
