...
echo "creating VLANs...
	...
	id=10, name=gwm, member ports=[1,2,6,9,10], untagged ports=[6]
	id=11, name=gws, member ports=[1,2,6,9,10], untagged ports=[0]
	id=12, name=gwp, member ports=[1,2,6,9,10], untagged ports=[0]
...
snmpset -v 1 -c private $ip 1.3.6.1.2.1.17.7.1.4.3.1.2.10 x C4C00000 >> /tmp/conflog.txt		#set vlan10 members ports 1,2,6,9,10
snmpset -v 1 -c private $ip 1.3.6.1.2.1.17.7.1.4.3.1.4.10 x 04000000 >> /tmp/conflog.txt		#set vlan10 untagged ports 6
...
snmpset -v 1 -c private $ip 1.3.6.1.2.1.17.7.1.4.3.1.2.12 x C4C00000 >> /tmp/conflog.txt		#set vlan12 members ports 1,2,6,9,10
